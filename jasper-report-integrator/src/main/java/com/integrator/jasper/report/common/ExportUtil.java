package com.integrator.jasper.report.common;
...
public class ExportUtil {
	...
	public static void exportReportHTMLToStream(JasperPrint jasperPrint, ByteArrayOutputStream outputStream)
			throws JRException {
	...
	public static void exportReportXLSToStream(JasperPrint jasperPrint, ByteArrayOutputStream outputStream)
			throws JRException {
	...
	public static void exportReportCSVToStream(JasperPrint jasperPrint, ByteArrayOutputStream outputStream)
			throws JRException {
	...
	public static void exportReportDocToStream(JasperPrint jasperPrint, ByteArrayOutputStream outputStream)
			throws JRException {
	...
	public static void exportReportToPdfStream(JasperPrint jasperPrint, ByteArrayOutputStream outputStream)
			throws JRException {
	...
	public static void exportToXLSFile(JasperPrint jasperPrint, String destFilePath)
